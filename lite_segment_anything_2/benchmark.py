...
from lite_segment_anything_2.build_litesam2 import (
    build_litesam2_video_predictor,
)
...
model_cfg = "configs/litesam2/litesam2_512x512.yaml"
litesam2_checkpoint = None

# Build video predictor with vos_optimized=True setting
predictor = build_litesam2_video_predictor(
    model_cfg, litesam2_checkpoint, device=device, vos_optimized=True
)
