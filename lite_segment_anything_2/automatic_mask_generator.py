...
import numpy as np
import torch
from lite_segment_anything_2.litesam2_image_predictor import (
    LiteSAM2ImagePredictor,
)

from lite_segment_anything_2.modeling.litesam2_base import LiteSAM2Base
from lite_segment_anything_2.utils.amg import (
    area_from_rle,
    batch_iterator,
    batched_mask_to_box,
    box_xyxy_to_xywh,
...
class LiteSAM2AutomaticMaskGenerator:
    def __init__(
        self,
        model: LiteSAM2Base,
        ...
        **kwargs,
        ...
        self.predictor = LiteSAM2ImagePredictor(
            model,
    ...
    def from_pretrained(
    ...
    ) -> "LiteSAM2AutomaticMaskGenerator":
        """
        ...
        litesam2_model = build_litesam2_hf(model_id, **kwargs)
        return cls(litesam2_model, **kwargs)
